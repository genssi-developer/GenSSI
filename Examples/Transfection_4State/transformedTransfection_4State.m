function model = transformedTransfection_4State()
	...
	model.sym.xdot = [-mRNA_div_mRNA0*(d1 + d2_times_mRNA0*enz_div_mRNA0),kTL_times_mRNA0*mRNA_div_mRNA0 - GFP*b,d3*enz0_div_mRNA0 - d3*enz_div_mRNA0 - d2_times_mRNA0*enz_div_mRNA0*mRNA_div_mRNA0];
