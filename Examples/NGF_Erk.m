...
% 	syms TrkA_NGF RasGTP pRaf pMek pErk
	...
	model.Name = 'NGF_Erk';
	model.Nder = 15;
	model.X = [k_3__TrkA_NGF,k_6__RasGTP,k_8__pRaf,k_10__pMek,s__pErk];
	model.Neq = 5;
	model.G = [0  0  0  0  0];
	model.Noc = 0;
	model.P = [k_1,k_2,k_4,k_5,k_7,k_9,k_11,...
               k_3__TrkA_0,k_6__Ras_0,k_8__Raf_0,k_10__Mek_0,...
               s__Erk_0,s_K,n,NGF_0];
    model.Par = [k_1,k_2,k_9,k_11];
	model.Npar = 4;
	model.IC = [0,...
	...
	model.H = [s__pErk];
	model.Nobs = 1;
    model.F = [-k_3__TrkA_NGF*k_2-NGF_0*k_1*(k_3__TrkA_NGF-k_3__TrkA_0),...
